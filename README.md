...
```
require('fun_with_flags')({ ... your definition object here ... });
```
...
##Bash Completion
For completion put the fli\_completion file in i/etc/bash\_completion.d/. If that doesn't work or you don't have that folder, just put it anywhere and source it in your .bashrc or .bash\_profile. Your script must run once to generate the autocomplete options. It then updates them whenever it is run.
